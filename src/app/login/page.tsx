      ...
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          <Link href="/" className="inline-block mb-4">
            <Image src="https://placehold.co/60x60.png?bg=87CEEB&text=P" alt="PathAssist Logo" width={60} height={60} className="mx-auto rounded-full" data-ai-hint="logo health"/>
          </Link>
